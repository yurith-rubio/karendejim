const PROJECTS = [
  ...
  {
    slug: "mastering-sustainability-in-printing",
    title: "Mastering Sustainability in Printing",
    cover: "/image/cover-Thesis_Sustainability.png",
    images: [
      "https://www.youtube.com/embed/b_cX501Mcn8?si=UFPiPw_LqgW6lXEJ&autoplay=1",
      ...
      "https://www.youtube.com/embed/GRKlekz9D2o?si=cggJwpUFPjm2ECcU",
      "/project-images/Thesis_Sustainability_5.jpg",
      "/project-images/Thesis_Sustainability_6.png",
      "/project-images/Thesis_Sustainability_7.png",
      "/project-images/Thesis_Sustainability_8.png",
      "/project-images/Thesis_Sustainability_9.png",
      "/project-images/Thesis_Sustainability_10.png",
      "/project-images/Thesis_Sustainability_11.png",
    ],
    description: `This Master Thesis explores sustainable graphic design practices in the printing industry, culminating in the creation of a software prototype as a design solution. By studying user interactions, the thesis focuses on reducing paper and ink waste, examining current environmental impacts, sustainable printing methods, and potential solutions to promote eco-friendly practices among graphic designers and clients. Through literature review, quantitative research, interviews, and observational studies, the project aims to raise awareness and encourage the adoption of sustainable printing solutions.`,
  },
  {
